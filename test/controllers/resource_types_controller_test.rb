...
class ResourceTypesControllerTest < ActionController::TestCase
  ...
  test "should create resource_type" do
    assert_difference('ResourceType.count') do
      post :create, resource_type: { professional_level_id: @resource_type.professional_level_id, type: @resource_type.type }
    end
  ...
  test "should update resource_type" do
    patch :update, id: @resource_type, resource_type: { professional_level_id: @resource_type.professional_level_id, type: @resource_type.type }
    assert_redirected_to resource_type_path(assigns(:resource_type))
  end
